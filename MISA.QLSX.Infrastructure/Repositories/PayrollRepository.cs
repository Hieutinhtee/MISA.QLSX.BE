...
namespace MISA.QLSX.Infrastructure.Repositories
{
    ...
    public class PayrollRepository : BaseRepository<Payroll>, IPayrollRepository
    {
        ...
        {
            return new HashSet<string> { "payroll_code", "status", "employee_code", "full_name" };
        }

        protected override string GetReadTableName() => "vw_payroll_detail";
        ...
        protected override Dictionary<string, FieldMapItem> FieldMap =>
            new()
            {
                ...
                ["workingDaysActual"] = new()
                {
                    Column = "working_days_actual",
                    DataType = typeof(decimal),
                    Operators = new() { "eq", "lt", "lte", "gt", "gte", "neq" },
                },
                ["workingDaysStandard"] = new()
                {
                ...
                ["lockedAt"] = new()
                {
                    ...
                    Operators = new() { "eq", "lt", "lte", "gt", "gte", "isnull", "notnull" },
                },
                ["paidAt"] = new()
                {
                    Column = "paid_at",
        ...
        public async Task<List<Payroll>> GetBySalaryPeriodAsync(
            Guid salaryPeriodId,
